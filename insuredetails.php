    ...
    header('Access-Control-Allow-Header:Access-Control-Allow-Header,Content-Type,Access-Control-Allow_methods,Auhtorization');
        ...
        if($_SERVER['REQUEST_METHOD']==='POST'){
            ...
            $go1_totalgrosspremium = isset($params ['go1_totalgrosspremium'])?$params ['go1_totalgrosspremium']:'';
                ...
                $isValid=1;
                $paramsValue=array('makemodel','rtolocation','vregnum','mfgyear','title','cgender','cfname','clname','caadhar','cpan', 'cmobile','cdob','coccup','cnname','cnage','crship','compname','nob','doi','compmail','gst','comppan','compcpname','compcprelation','photo','go1_totalgrosspremium');
